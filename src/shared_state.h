...
bool shared_state_has_mutex(shared_state_ref, mutex_refc);
void shared_state_add_mutex(shared_state_ref, mutex_refc);

shared_state_ref next(shared_state_ref, transition_ref, transition_ref);
void shared_state_update_next_transition_for_thread(shared_state_ref, thread_ref, transition_ref);
