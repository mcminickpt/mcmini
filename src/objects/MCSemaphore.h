...
public:
    ...
    inline MCSemaphore(const MCSemaphore &sem) : MCVisibleObject(sem.getObjectId()),
    semShadow(sem.semShadow), waitingQueue(sem.waitingQueue), spuriousWakeupCount(sem.spuriousWakeupCount)
    {}
