...
// decltype(&pthread_create) pthread_create_ptr;
// decltype(&pthread_join) pthread_join_ptr;
// decltype(&pthread_mutex_init) pthread_mutex_init_ptr;
// decltype(&pthread_mutex_lock) pthread_mutex_lock_ptr;
// decltype(&pthread_mutex_unlock) pthread_mutex_unlock_ptr;
// decltype(&sem_wait) sem_wait_ptr;
// decltype(&sem_post) sem_post_ptr;
// decltype(&sem_init) sem_init_ptr;
// decltype(&exit) exit_ptr;
// decltype(&abort) abort_ptr;
// decltype(&pthread_barrier_init) pthread_barrier_init_ptr;
// decltype(&pthread_barrier_wait) pthread_barrier_wait_ptr;
// decltype(&pthread_cond_init) pthread_cond_init_ptr;
// decltype(&pthread_cond_wait) pthread_cond_wait_ptr;
// decltype(&pthread_cond_signal) pthread_cond_signal_ptr;
// decltype(&pthread_cond_broadcast) pthread_cond_broadcast_ptr;
// decltype(&pthread_rwlock_init) pthread_rwlock_init_ptr;
// decltype(&pthread_rwlock_rdlock) pthread_rwlock_rdlock_ptr;
// decltype(&pthread_rwlock_wrlock) pthread_rwlock_wrlock_ptr;
// decltype(&pthread_rwlock_unlock) pthread_rwlock_unlock_ptr;
// decltype(&sleep) sleep_ptr;
...
//   pthread_rwlock_rdlock_ptr = dlsym(RTLD_NEXT, "pthread_rwlock_rdlock");
//   pthread_rwlock_wrlock_ptr = dlsym(RTLD_NEXT, "pthread_rwlock_wrlock");
//   pthread_rwlock_unlock_ptr = dlsym(RTLD_NEXT, "pthread_rwlock_unlock");
...
// void abort() { mc_transparent_abort(); }
...
// int pthread_rwwlock_init(pthread_rwwlock_t *rwwlock) {
//   return mc_pthread_rwwlock_init(rwwlock);
// }

// int pthread_rwwlock_rdlock(pthread_rwwlock_t *rwwlock) {
//   return mc_pthread_rwwlock_rdlock(rwwlock);
// }

// int pthread_rwwlock_wr1lock(pthread_rwwlock_t *rwwlock) {
//   return mc_pthread_rwwlock_wr1lock(rwwlock);
// }

// int pthread_rwwlock_wr2lock(pthread_rwwlock_t *rwwlock) {
//   return mc_pthread_rwwlock_wr2lock(rwwlock);
// }

// int pthread_rwwlock_unlock(pthread_rwwlock_t *rwwlock) {
//   return mc_pthread_rwwlock_unlock(rwwlock);
// }

// int pthread_rwwlock_destroy(pthread_rwwlock_t *rwwlock) {
